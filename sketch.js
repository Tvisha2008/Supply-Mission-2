...
function setup() {
	...
	//create red box
	 boxbase = Bodies.rectangle(width/2, 645, 200, 20 , {isStatic:true} );
	 World.add(world, boxbase);

	 boxleft = Bodies.rectangle(width/2-100, 600, 20, 100 , {isStatic:true} );
	 World.add(world, boxleft);

	 boxright = Bodies.rectangle(width/2+100, 600, 20, 100 , {isStatic:true} );
